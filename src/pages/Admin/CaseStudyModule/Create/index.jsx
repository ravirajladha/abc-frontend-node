...
import { createCaseStudyModules } from '@/api/admin';
...
function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await createCaseStudyModules(caseStudyId,submissionData);
  ...
  return (
    <>
      ...
      <ContentFormWrapper formTitle="Case study Modules">
