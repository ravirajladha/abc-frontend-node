...
import { createCaseStudySections } from '@/api/admin';
...
function Create() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await createCaseStudySections(caseStudyId,caseStudyModuleId,submissionData);
  ...
  return (
    ...
    <ContentFormWrapper formTitle="Case Study Section">
